...
<head>
    ...
    <title>Laman Utama Pelajar | SDOAU</title>
            ...
            <div class="wrapper wrapper-content">
                <div class="row">
                    ...
                    <div class="col-lg-3">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                <h5><span class="label label-primary pull-right">ID Permohonan</span>
                                </h5>
                    ...
                    <div class="col-lg-3">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                <h5><span class="label label-info pull-right">Tarikh Permohonan</span>
                                </h5>
                            </div>
                            <div class="ibox-content">
                                <h3 class="no-margins"><?php echo $rowaccess['application_date'];  ?></h3>
                                <small> </small>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                <h5><span class="label label-secondary pull-right">Status Permohonan</span>
                                </h5>
                            </div>
                            <div class="ibox-content">
                                <h3 class="no-margins">
                                    <?php if (($rowaccess['status']) != "" and (($rowaccess['status']) != "0")) { ?>
                                        <span class="badge badge-primary">Tawaran telah Disahkan</span> <br>
                                        <span class="badge badge-primary">Kod Program: <?php echo $status = $rowaccess['status']; ?> </span><br>
                                        <span class="badge badge-primary">Nama Program: <?php $kod_status = $rowaccess['kod_status']; echo strstr($kod_status, '/', true); ?> </span>
