...
<body class="hold-transition login-page">
  <div class="login-box">
    <div class="login-logo">
      <a href="\student_enrollment\admission\index.php"><b><img src="../images/logo.png" width="150" height="110"><span class="style1"> </span></b><span class="style1"></span></a>
    </div>
    <!-- /.login-logo -->
    <div class="card">
