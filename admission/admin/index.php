...
<head>
  ...
  <title>Laman Utama Admin | SDOAU</title>
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          <div class="image">
            <img src="../upload/pppa.jpg" alt="User Image" width="220" height="192" class="img-circle elevation-2">
          </div>
          <div class="info">
      ...
      <section class="content">
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-lg-3 col-6">
              ...
              <div class="small-box bg-info">
                <div class="inner">
                  ...
                  <p><strong>Jumlah Pemohon yang Berdaftar </strong></p>
                </div>
                <div class="icon">
                  <i class=""></i>
                </div>
            ...
            $query = "SELECT * FROM tbl_pemohon where status != '0' and  status != ''";
            $result = mysqli_query($conn, $query);
            ...
            <div class="col-lg-3 col-6">
              ...
              <div class="small-box bg-success">
                <div class="inner">
                  ...
                  <p><strong>Jumlah Permohonan yang telah Disahkan </strong></p>
                </div>
                <div class="icon">
                  <i class=""></i>
                </div>
